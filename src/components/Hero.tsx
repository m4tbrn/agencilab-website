          ...
          <div className="grid lg:grid-cols-[1.2fr_1fr]">
            ...
            <div className="flex flex-col justify-center p-5 sm:p-8 lg:p-10">
              ...
              <h1 className="mb-5 text-3xl font-bold leading-[1.15] tracking-tight sm:text-4xl lg:text-[2.75rem]">
                Apprends le <span className="gradient-text">Growth Marketing</span>, une activité (très) rentable qui peut te générer <span className="gradient-text">+2 987€/mois</span> depuis chez toi.
              </h1>
