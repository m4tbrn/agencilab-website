...
export default function DevenirLibreCapture() {
  return (
    <CoursContent
      source="ig"
      tallySrc="https://tally.so/embed/q4ojxG?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
      tallyTitle="Formulaire de capture - VSL Incubateur - Instagram Louis Esquier"
    />
  );
}
