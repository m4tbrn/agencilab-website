...
/**
 * Écran de déverrouillage du pitch deck. Affiché tant que le cookie
...
export default function PasswordGate() {
  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center bg-navy-950 px-6 text-white">
      <div
        aria-hidden
      ...
      <div className="relative w-full max-w-[380px]">
        ...
        <h1 className="text-[1.6rem] font-black leading-tight tracking-tight text-white md:text-[1.9rem]">
          Pitch deck — L'Incubateur
        </h1>
        <p className="mt-2.5 text-[0.92rem] leading-relaxed text-white/55">
          Cette présentation est privée. Saisis le mot de passe pour y accéder.
        </p>
        ...
        <form action={formAction} className="mt-7 flex flex-col gap-3">
          ...
          >
            {pending ? "Vérification..." : "Accéder au deck"}
          </button>
        </form>
      </div>
    </div>
